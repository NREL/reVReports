...
VERSION_FILE = os.path.join(REPO_DIR, "reVReports", "version.py")
DESCRIPTION = (
    "For creating standarized graphics to summarize/report outputs from reV supply "
    "curves."
)
...
setup(
    ...
    package_dir={"reVReports": "reVReports"},
    entry_points={
        "console_scripts": [
            "reVReports=reVReports.cli:main",
        ],
    },
    zip_safe=False,
    keywords="reVReports",
    ...
    package_data={"": ["datasets/*", "datasets/**/*", "assets/*"]},
